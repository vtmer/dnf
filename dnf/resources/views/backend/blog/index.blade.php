...
<div id="content-wrapper">
    <div class="page-header">
        <div class="row">
            ...
            <h1 class="col-xs-12 col-sm-10 text-center text-left-sm"><i class="fa fa-pencil page-header-icon"></i>&nbsp;&nbsp;{{ Lang::get('backend.article-management') }}</h1>
            <div class="col-xs-12 col-sm-2">
                <div class="row">
                    <hr class="visible-xs no-grid-gutter-h">

                    <!-- "Create project" button, width=auto on desktops -->
                    <div class="pull-right col-xs-12 col-sm-auto">{!! AclWidget::add(route('backend_blog_articles_create'), 'blog', 'articles', '_create', Lang::get('backend.create')) !!}</div>
                            ...
                            <tbody>
                                ...
                                <tr id="articleList-data-id-{{ $data->id }}">
                                    ...
                                    <td class= "center">
                                         ...
                                         {!! AclWidget::edit(route('backend_blog_articles_update', ['id' => $data->id]), 'blog', 'articles', 'update', null) !!}
                                         {!! AclWidget::delete(route('backend_blog_articles_softdelete', false), 'blog', 'articles', 'softdelete', 'articleList', $data->id ) !!}
